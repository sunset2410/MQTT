...
void pub()
{
    dcepf_mqtt_sp_invoke_publish(100, "topic/qos0", "6 0", 0);
    dcepf_mqtt_sp_invoke_publish(100, "topic/qos1", "6 1", 1);
    dcepf_mqtt_sp_invoke_publish(100, "topic/qos2", "6 2", 2);
}
...
void unsub()
{
    dcepf_mqtt_sp_invoke_unsubscribe(100, "topic/qos0");
    dcepf_mqtt_sp_invoke_unsubscribe(100, "topic/qos1");
    dcepf_mqtt_sp_invoke_unsubscribe(100, "topic/qos2");
    dcepf_mqtt_sp_invoke_unsubscribe(200, "topic/#");

    dcepf_mqtt_sp_invoke_unsubscribe(300, "topic/client03/#");
}
